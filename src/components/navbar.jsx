      ...
      >
        ...
        <div className="flex items-center">
          ...
          <div className="hidden lg:flex lg:items-center lg:gap-x-8">
            ...
            {/* Leads dropdown - only show if authenticated */}
            {isAuthenticated && (
            ...
            {isAuthenticated ? (
              <button
                onClick={logout}
                className="flex items-center gap-x-2 text-sm font-semibold leading-6 text-white hover:text-red-400 transition-colors cursor-pointer"
              >
              ...
              <Link
                href="/admin-login"
                className="flex items-center gap-x-2 text-sm font-semibold leading-6 text-white hover:text-yellow-500 transition-colors bg-indigo-600 px-3 py-2 rounded-md hover:bg-indigo-700"
              >
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-700">
              <div className="space-y-2 py-6">
                ...
                {/* Leads section - only show if authenticated */}
                {isAuthenticated && (
                  <>
                ...
                {isAuthenticated ? (
                  <button
                    ...
                    className="-mx-3 flex items-center gap-x-2 rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800 w-full text-left"
                  >
                    <ArrowRightStartOnRectangleIcon className="h-5 w-5" />
                    Admin Logout
                  </button>
                  ...
                  <Link
                    href="/admin-login"
                    className="-mx-3 flex items-center gap-x-2 rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800"
                    onClick={() => setMobileMenuOpen(false)}
                  >
