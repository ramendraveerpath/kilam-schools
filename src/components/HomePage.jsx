...
const stats = [
  { name: "Successful Selections", value: "100+", icon: AcademicCapIcon },
  { name: "Years of Experience", value: "10+", icon: TrophyIcon },
  { name: "Expert Faculty", value: "5+", icon: UserGroupIcon },
