...
const faqs = [
  {
    id: "exam-prep",
    question: "What exams does VEERPATH ACADEMY(VDA) prepare students for?",
    answer:
      "We offer expert coaching for the following categories:\n1. Residential School Entrance Exams - (JNV/SAINIK/RMS/RIMCS Etc.)\n2. Board Exams - 9th-10th & 11th-12th (CBSE/ICSE/State Board Exams like UP, Bihar Etc.)\n3. Defence Exams (NDA/CDS/AFCAT/CAPF Etc.)\n4. CUET\n5. CLAT",
  },
  {
    id: "class-modes",
  ...
  {
    id: "course-types",
    question: "What types of courses are available on Veerpath?",
    answer:
      "We offer a variety of programs to suit every student:Foundation Courses (10- 12 months)Crash Courses (30–60 days)Target Batches (Exam-specific)",
  },
];
...
const testimonials = [
  {
    ...
    content:
      "VEERPATH ACADEMY(VDA) guided my child excellently. The faculty is experienced and the study material is comprehensive. My son cleared JNVST Class 6 in the first attempt!",
    rating: 5,
  },
  {
    id: "parent-2",
            ...
            <div className="lg:col-span-2 pt-16 md:pt-20 lg:pt-24 lg:pr-8">
              <div className="max-w-2xl">
                ...
                <p className="mt-6 text-xl leading-8 text-gray-600">
                  Get in touch with VEERPATH ACADEMY(VDA). We're here to help
