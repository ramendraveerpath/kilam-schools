            ...
            <div className="lg:col-span-2 pt-16 md:pt-20 lg:pt-24 lg:pr-8">
              <div className="max-w-2xl">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Welcome to VEERPATH ACADEMY (VDA) -your gateway to quality education in both Hindi and English. We provide Online & Offline comprehensive courses designed to help students excel in competitive exams and school board assessments. Whether you're preparing for Jawahar Navodaya Vidyalaya Selection Test (JNVST), The All India Sainik School Entrance Examination (AISSEE) and Rashtriya Military School (RMS), aiming for success in National Defence Academy (NDA), Combined Defence Service (CDS) , AFCAT, Common University Entrance Test (CUET), Common Law Admission Test (CLAT) or looking to strengthen your performance in State Board, CBSE, or ICSE exams, our expert-guided programs support you every step of the way.
With a student-centered approach, accessible bilingual content, and a focus on clarity and concept-based learning, we’re committed to empowering learners to achieve their academic goals with confidence. Join us and take the next step toward a brighter future!
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Our mission is to make quality education accessible to every student, regardless of their location, and to empower them to achieve their academic and career aspirations. We are dedicated to preparing learners for admission into premier residential schools such as JNV, Sainik Schools, and RMS; guiding them to excel in Defence examinations like NDA and CDS; supporting them in achieving outstanding results in Board examinations across CBSE, ICSE, and State Boards; and equipping them for CUET and other competitive examinations that pave the way for higher education and professional success
          </p>
        </div>
      ...
      <div className="bg-gray-50 py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Why to Choose Veerpath Academy (VDA)?
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Veerpath Academy stands out as a dedicated institution committed to shaping the academic and career success of students across the nation. We combine expert mentorship, innovative teaching methods, and focused preparation strategies to help learners unlock their full potential.
            </p>
          </div>
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
        ...
        <div className="mx-auto mt-24 max-w-3xl lg:text-center">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-4">
            ...
            {/* <div className="rounded-lg bg-indigo-50 p-6 text-center shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out">
              ...
              <p className="text-sm text-gray-600">for UG & PG Level</p>
            </div> */}
            <a 
